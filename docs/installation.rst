...
This is the preferred method to install gpplot, as it will always install the most recent stable release.
...
The sources for gpplot can be downloaded from the `Github repo`_.
